...
class GraduadoController extends Controller
{
    ...
    private function validateGraduado(Request $request, $graduadoId = null)
    {
        return $request->validate([
            ...
            'ocupaciones' => 'nullable|array',
            'ocupaciones.*.ocupacion_trabajo' => 'nullable|string',
            'ocupaciones.*.ocupacion_empresa' => 'nullable|string',
            'ocupaciones.*.ocupacion_sector' => 'nullable|string',
            'ocupaciones.*.ocupacion_informacion_adicional' => 'nullable|string|max:500',
